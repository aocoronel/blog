...
C was the first programming language I've learned. It took me a very long time to make the decision to learn it among so many options. I thought it was the very best choice. Today? I partially agree with it, because C is perfect to learn programming. Let me remake this sentence: Perfect to learn programming, not just how to write C code, but programming. This was the main source of knowledge that powers me today to pick any language and just go write stuff.
...
Note how I run the actual code in a function, and all the operations that would require me to do more advanced error prone tricks with offsets and the size of the struct, I did them in the macro level. This is terrible code, I'm not proud for writing this. Don't copy me. Although I wanted a much better solution than this, there is another project (in the topic of hashmap for context) available here: [google/cwisstable](https://github.com/google/cwisstable), and in there people achieve multiple type support by generating structs and functions, which costs you debugging information that is very valuable in a debugger, but by leveraging this cost, the API is much nicer to use.
...
When I write C, and I get a nasty bug, I always think with myself: "it would be so much nicer if I've had written this in Rust, and the compiler tell me what's wrong", until it can't, and then I'm cooked again. My true thoughts on Rust? I like Rust, don't get me wrong (I have quite a couple or projects in Rust, because I cared about safety in them), but it's not the style of programming I like to do, I would be much nicer if I had a data oriented Rust programming language, that is simple with fewer abstractions.
